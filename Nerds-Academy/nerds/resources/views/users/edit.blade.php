        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <form  action="{{ route('users.update',$person->id) }}"  method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="f_name" type="text" value="{{$person->f_name}}" class="form-control{{ $errors->has('f_name') ? ' is-invalid' : '' }}" name="f_name" value="{{ old('f_name') }}" required >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="l_name" type="text" class="form-control{{ $errors->has('l_name') ? ' is-invalid' : '' }}" name="l_name"  value="{{$person->l_name}}" required >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="username" type="text" class="form-control{{ $errors->has('username') ? ' is-invalid' : '' }}" name="username" value="{{$person->username}}" required >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="university_name" type="text" class="form-control{{ $errors->has('university_name') ? ' is-invalid' : '' }}" name="university_name" value="{{$person->university_name}}"  required >
